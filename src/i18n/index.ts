...
const T = {
  ru: {
    ...
    checkout_change_label:       "Нужна сдача?",
    checkout_change_yes:         "Нужна сдача",
    checkout_change_no:          "Без сдачи",
    checkout_change_from:        "С какой суммы?",
    checkout_change_placeholder: "Например, 50",
  ...
  en: {
    ...
    checkout_card:               "Card",
    checkout_change_label:       "Do you need change?",
    checkout_change_yes:         "Need change",
    checkout_change_no:          "No change needed",
    checkout_change_from:        "Pay with how much?",
    checkout_change_placeholder: "e.g. 50",
